// =========================================================
//   داده‌های پروفایل و نمونه‌کارها (همسان با نسخه‌ی پایتون)
//   -- این بخش دست‌نخورده مونده، فقط جابه‌جا شده به فایل جدا --
// =========================================================
...
fileInput.addEventListener("change", () => {
  ...
  if(file.size > 6 * 1024 * 1024){
    window.alert("حجم تصویر باید کمتر از ۶ مگابایت باشد.");
    fileInput.value = "";
    return;
  }
